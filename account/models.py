...
from .constants import GENDER_CHOICE, CURRENCY_CHOICE, MONEY_CHOICE, STATUS_CHOICES, TRANSFER_CHOICES, TITLE_CHOICE, OTP_CHOICES
...
class UserBankAccount(models.Model):
    ...
    anual_income = models.CharField(max_length=20, choices=MONEY_CHOICE)
    asset_worth = models.CharField(max_length=20, choices=MONEY_CHOICE)
    credit_worth = models.CharField(max_length=20, choices=MONEY_CHOICE)
