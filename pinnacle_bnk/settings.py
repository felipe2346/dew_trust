...
ALLOWED_HOSTS = ["127.0.0.1", ".vercel.app", ".now.sh", 'localhost', 'dewtrustonlinefb.com', 'www.dewtrustonlinefb.com']
...
ROOT_URLCONF = 'pinnacle_bnk.urls'
...
WSGI_APPLICATION = 'pinnacle_bnk.wsgi.application'
